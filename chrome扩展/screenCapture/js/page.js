...
var page = {
     ...
     * 检测 固定定位元素 在可视区域的相对的位置 ：左上，右上 ，左下，右下
     * @param {Element} elem
     ...
     * 接收来自background页面的消息，然后决定下一步做什么
     */

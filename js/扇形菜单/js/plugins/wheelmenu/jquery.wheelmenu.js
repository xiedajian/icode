...
/*                left: el.outerWidth() / 2 + "px",
    ...
    $.fn.showIcon = function (button, settings,childFlag,prentEl) {
        var el = this,
            zindex = '6',
            centerAroundEle=$(settings.centerAroundEle);
        ...
        return this.each(function(){
            ...
            if (settings.trigger == "hover") {
                ...
                el.find('a').each(function(){
                    var childEl = $($(this).attr("href"));
                    $(this).bind({
                        mouseover:function(e){
                            console.info("父元素里的条目移入");
                            var childFlag=true,prentEl=el;
                            childEl.siblings().css('display','none');
                            childEl.showIcon(button, settings,childFlag,prentEl);
                        }
                    });
                })
